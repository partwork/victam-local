    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-top-elements">
                ...
                <a href="<?php echo base_url('admin/content-management/market-info/add-interviews') ?>" class="btn btn-blue float-right f-14 pl-4 pr-4">Add New Interviews</a>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-12">
            <div class="filter-wrap">
                <div class="status-wrap">
                    ...
                    <select id="IntstatusFilter" class="form-control" required>
                ...
                <div class="search-wrap">
                    <input type="text" id="int_input_search" class="form-control" placeholder="Search">
                </div>
            </div>
        </div>
    </div>
            ...
            ?> 
                <div class="col-sm-3 pl-1 pr-3 mb-3">
                    <div class="interviews-card-wrapper w-100">
                        <div class="card">
                            <?php if(isset($list->vic_bn_youtubeURL) && $list->vic_bn_youtubeURL!=''): ?>
                            ...
                            <?php elseif(isset($list->vic_blogs_news_video) && $list->vic_blogs_news_video!=''): ?>
                            ...
                            <div class="card-body text-center">
                                <h6 class="card-title f-14 text-blue mt-2" title="2020 IDMA"><?php echo $list->vic_bn_title; ?></h6>
