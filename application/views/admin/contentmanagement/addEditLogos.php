<div class="container-fluid body-wrapper pl-24vw">
    ...
    <form id="addLogo-form" method="post" enctype="multipart/form-data">
        <input type="hidden" name="logo_ismepty" id="logo_ismepty" value="<?php if (isset($content['0'])) {
                                                                                echo $content['0']->vic_banner_id;
                                                                            } ?>">
        <input type="hidden" name="banner_id" id="banner_id" value="<?php if (isset($content['0'])) {
                                                                        echo $content['0']->vic_banner_id;
                                                                    } ?>">
        <div class="row">
            <div class="col-sm-12">
                <div class="page-top-elements">
                    <h4 class="page-title-wrap">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item" aria-current="page"> <a class="text-blue" href="<?php echo base_url(); ?>admin/content-management/home/logos">Logos</a> </li>
                    ...
                    <?php } else { ?>
                        <a href="<?php echo base_url(); ?>admin/content-management/home/logos" class="btn btn-blue-border float-right f-14 pl-4 pr-4">Cancel</a>
                    <?php } ?>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="form-wrapper">
                    <!-- <form id="addlatestlogos"> -->
                    <input id="imgPath" name="imgPath" type="hidden" <?php if (isset($content['0'])) : ?> value="<?php echo $content['0']->vic_logo_image_path ?>" <?php endif; ?>>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" placeholder="Enter Logo URL" name="logourl" <?php if (isset($content['0'])) : ?> value="<?php echo $content['0']->vic_logo_url ?>" <?php endif; ?>>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" name="position" required>
                                <option value="" disabled selected hidden class="placeholder-text">Select Logo Position</option>
                                <?php
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <div class="date-input-wrapper ">
                                ...
                                <input type="text" class="form-control fromdate" id="logoFrom" name="dfrom" placeholder="Enter Date" <?php if (isset($content['0'])) : ?> value="<?php echo date('Y-m-d',strtotime($content['0']->vic_banner_duration_from)) ?>" <?php endif; ?>>
                            </div>
                        </div>
                        <div class="col-sm-5">
                            <div class="date-input-wrapper ">
                                <label class="col-form-label mr-3">To</label>
                                <input type="text" class="form-control todate" id="logoTo" name="tfrom" placeholder="Enter Date" <?php if (isset($content['0'])) : ?> value="<?php echo date('Y-m-d',strtotime($content['0']->vic_banner_duration_to)) ?>" <?php endif; ?>>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row upload-image-wrapper-outer">
                        <label class="col-sm-2 col-form-label">Upload Image</label>
                        <!-- <div class="col-sm-10 center-align-lable">
                            <input type="file" id="upload-attachment-file" hidden="hidden" name="bfile"/>
                        ...
                        <div class="col-sm-10  pos-rel">
                            ...
                            <input id="media_data" name="media_data" type="hidden" <?php if (isset($content['0'])) : ?> value="<?php echo base_url('upload/company/' . $content['0']->vic_logo_image_path); ?>" <?php endif; ?>>
                        </div>
                    </div>
                    <div class="form-group row">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="text-center">
                    ...
                    <div id="previewImg">
                        <img <?php if (isset($content['0'])) : ?> src="<?php echo base_url('upload/company/' . $content['0']->vic_logo_image_path); ?>" <?php endif; ?> class="img-fluid w-100 p-3" id="preview_img" />
...
<!-- Publish Modal -->
<div class="modal fade" id="logos" role="dialog" aria-labelledby="publish" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            ...
            <div class="modal-body">
                <div class="text-center">
                    <img src="<?php echo base_url(); ?>application/assets/shared/img/admin/logo.png">
                    <img src="" class="img-fluid w-100 p-3"id="preview_img">
                    ...
                    <div class="text-center">
                        <a href="<?php echo base_url(); ?>admin/content-management/home/logos" type="button" class="add-company-details">OK</a>
                    </div>
                </div>
            </div>
        </div>
