                ...
                <h4 class="page-title-wrap">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Research & Innovations</li>
                        </ol>
                    </nav>
                </h4>
                <a href="<?php echo base_url('admin/content-management/resource-library/addresearchInnovations') ?>" class="btn btn-blue float-right f-14 pl-4 pr-4">Add New Innovations</a>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-12">
            <div class="filter-wrap">
                ...
                <div class="search-wrap">
                    <input type="text" class="form-control" placeholder="Search" id="res_input_search">
                </div>
            </div>
        </div>
        <div class="col-sm-12">
            <div class="table-wrapper">
                <table id="ResearchInnovations" class="display table" style="width:100%;table-layout:fixed;">
