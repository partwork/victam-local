    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-top-elements">
                <h4 class="page-title-wrap">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page"> <a class="text-blue" href="<?php echo base_url(); ?>admin/content-management/resource-library/caseStudies">Case Studies</a> </li>

                            <?php if ($activePage ==  'Edit') { ?>
                                <li class="breadcrumb-item active" aria-current="page">Edit Case Studies</li>
                            <?php } else { ?>
                ...
                <?php else : ?>
                    <a href="<?php echo base_url('admin/content-management/resource-library/caseStudies'); ?>" class="btn btn-blue-border float-right f-14 pl-4 pr-4">Cancel</a>
                <?php endif; ?>
        ...
        <div class="col-sm-12">
            <div class="form-wrapper">
                ...
                <div class="form-group row">
                    <label class="col-sm-4 col-form-label">Case Study Title<span class="text-danger">*</span></label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control inn_name" placeholder="Enter Case Study Title" <?php if (isset($inv_data) && !empty($inv_data)) : ?> value="<?php echo $inv_data->vic_resource_title; ?>" <?php endif; ?> name="inn_name" id="inn_name">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-4 col-form-label">Description<span class="text-danger">*</span></label>
                    <div class="col-sm-8">
                        <textarea class="form-control inn_desc" rows="4" name="inn_desc" id="inn_desc" placeholder="Enter Description"><?php if (isset($inv_data) && !empty($inv_data)) : ?> <?php echo trim($inv_data->vic_resource_desc); ?> <?php endif; ?></textarea>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-4 col-form-label">Industry Sector<span class="text-danger">*</span></label>
                    <div class="col-sm-8">
                        <select class="form-control inn_industry" id="inn_industry" name="inn_industry">
                ...
                <div class="form-group row upload-image-wrapper-outer">
                    ...
                    <div class="col-sm-8  pos-rel">
                        <div class="center-align-lable">
                            <button type="button" id="upload-attachment-button" class="custom-file-upload">Upload</button>
                            <span id="upload-video-file-name" class="input-file-name">Allowed file extensions: doc,docx,xls,xlsx and PDF maximum file size: 15MB</span>
                        </div>
                ...
                <div class="form-group row upload-image-wrapper-outer">
                    ...
                    <div class="col-sm-8  pos-rel">
                        ...
                        <input class="form-control visibility-hidden"  onchange="readURL(this,'inv_video');" style="position: absolute; left:0" type="file" id="upload-presentation-file" name="inn_presentation" />
               ...
               <!--  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" placeholder="Enter YouTube URL" value="<?php if (isset($inv_data) && !empty($inv_data)) {
                ...
                <div class="text-left">
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <a href="javascript:void(0)" download class="view_doc_model p_file" data-url="<?php if (isset($inv_data) && !empty($inv_data)): echo base_url('upload/resource_library/'.$inv_data->vic_resource_docs); endif;?>">
