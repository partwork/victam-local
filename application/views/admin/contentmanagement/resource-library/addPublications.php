<div class="container-fluid body-wrapper pl-24vw">
    <?php
    $attributes = array('id' => 'publication');
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-top-elements">
                <h4 class="page-title-wrap">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page"> <a class="text-blue" href="<?php echo base_url(); ?>admin/content-management/resource-library/publications">Publications</a> </li>
                ...
                <?php else : ?>
                    <a href="<?php echo base_url('admin/content-management/resource-library/publications'); ?>" class="btn btn-blue-border float-right f-14 pl-4 pr-4">Cancel</a>
                <?php endif; ?>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="form-wrapper">
                ...
                <input type="hidden" id="id" value="<?php if (isset($inv_data) && !empty($inv_data)) {
                                                        echo $inv_data->idvic_resource_library;
                                                    } ?>" name="id">


                <div class="form-group row">
                    <label class="col-sm-4 col-form-label">Publications Title<span class="text-danger">*</span></label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control inn_name" placeholder="Enter Publication Title" <?php if (isset($inv_data) && !empty($inv_data)) : ?> value="<?php echo $inv_data->vic_resource_title; ?>" <?php endif; ?> name="inn_name" id="inn_name">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8 pos-rel">
                        <input type="text" class="form-control inn_date" id="ridatepicker" placeholder="Enter Date" name="inn_date" <?php if (isset($inv_data) && !empty($inv_data)) : ?> value="<?php echo date('Y-m-d', strtotime($inv_data->vic_resource_date)); ?>" <?php endif; ?>>
                ...
                <div class="form-group row upload-image-wrapper-outer">
                    <label class="col-sm-4 col-form-label">Publication Attachment <span class="text-danger">*</span></label>
