    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-top-elements">
                ...
                <a href="<?php echo base_url('admin/content-management/resource-library/addPublications') ?>" class="btn btn-blue float-right f-14 pl-4 pr-4">Add New Publications</a>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-sm-12">
            <div class="table-wrapper">
                <table id="publications" class="display table" style="width:100%;table-layout:fixed;">
