<div class="container-fluid body-wrapper pl-24vw">
    ...
    <?php
    $attributes = array('id' => 'research_innovation');
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-top-elements">
                ...
                <!-- <form id="research_inno" method="post" action="home" enctype="multipart/form-data" novalidate> -->
                <?php if (isset($inv_data) && !empty($inv_data)) : ?>
                    <a data-toggle="modal" data-target="#rejectConfirmationModal" onclick="content_id('<?php echo $inv_data->idvic_resource_library; ?>')" class="btn btn-blue-border float-right f-14 pl-2 pr-2">Reject</a>
                <?php else : ?>
                    <a href="<?php echo base_url('admin/content-management/resource-library/researchInnovations'); ?>" class="btn btn-blue-border float-right f-14 pl-2 pr-2">Cancel</a>
                <?php endif; ?>
                ...
                <a href="#" onclick="resource_preview()" class="btn btn-blue-border float-right f-14 mr-3 pl-2 pr-2">Preview</a>
            </div>

            <div class="page-title-wrap">
                <nav aria-label="breadcrumb ">
                    <ol class="breadcrumb p-0 breadcrumb-1 ">
                        <li class="breadcrumb-item" aria-current="page">Resource Library</li>
                        <li class="breadcrumb-item" aria-current="page"> <a class="text-blue" href="<?php echo base_url(); ?>admin/content-management/resource-library/researchInnovations">Research & Innovations</a> </li>
                        <?php if ($activePage ==  'Edit') { ?>
                            <li class="breadcrumb-item active" aria-current="page">Edit Research & Innovations</li>
                        <?php } else { ?>
                            <li class="breadcrumb-item active" aria-current="page">Add Research & Innovations</li>
                        <?php } ?>
                    </ol>
                </nav>
            </div>
        ...
        <div class="col-sm-12">
            <div class="form-wrapper">
                ...
                <div class="form-group row">
                    <label class="col-sm-4 col-form-label">Innovation Title <span class="text-danger">*</span></label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control inn_name" <?php if (isset($inv_data) && !empty($inv_data)) : ?> value="<?php echo $inv_data->vic_resource_title; ?>" <?php endif; ?> name="inn_name" id="inn_name" placeholder="Enter Innovation Title ">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control inn_email" name="inn_email" id="inn_email" placeholder="Enter Email" <?php if (isset($inv_data) && !empty($inv_data)) : ?> value="<?php echo $inv_data->vic_resource_email; ?>" <?php endif; ?>>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row upload-image-wrapper-outer">
                    ...
                    <div class="col-sm-8 pos-rel">
                        ...
                        <input type="file" class="form-control visibility-hidden p-0" style="height: 0;" id="upload-presentation-file" name="inn_presentation" onchange="readURL(this,'inv_video');" />
                        <input type="hidden" value="<?php if (isset($inv_data) && $inv_data->vic_resource_presentation != '') {
                                                        echo base_url('upload/resource_library/' . $inv_data->vic_resource_presentation);
                                                    } ?>" id="inv_video">
                    </div>
                </div>
                <div class="form-group row upload-image-wrapper-outer">
                    <label class="col-sm-4 col-form-label">Research and Innovation Documents<span class="text-danger">*</span></label>
                    <div class="col-sm-8 pos-rel">
                        <div class="center-align-lable">
                            <button type="button" id="upload-attachment-button" class="custom-file-upload">Upload</button>
                            <span id="upload-attachment-file-name" class="input-file-name">Allowed file extensions: PDF, DOCX, TXT, maximum file size: 2MB</span>
                        </div>
                        <input type="file" class="form-control visibility-hidden p-0" style="height: 0;" id="upload-attachment-file" name="inn_doc" onchange="readURL(this,'inv_file');" />
                        <input type="hidden" value="<?php if (isset($inv_data) && $inv_data->vic_resource_thumbnail != '') {
                                                        echo base_url('upload/resource_library/' . $inv_data->vic_resource_thumbnail);
                                                    } ?>" id="inv_file">
                    </div>
                </div>
                <!-- <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" value="<?php if (isset($inv_data) && !empty($inv_data)) {
                                                                            echo $inv_data->vic_resource_youtube_url;
                                                                        } ?>" placeholder="Enter YouTube URL" name="inn_url" id="inn_url">
                    </div>
                </div> -->
                </form>
            </div>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-sm-5 text-center">
                                <a href="javascript:void(0)" class="view_doc_model p_file" data-url="<?php if (isset($inv_data) && !empty($inv_data)) : echo base_url('upload/resource_library/' . $inv_data->vic_resource_docs);
                                                                                                        endif; ?>">
