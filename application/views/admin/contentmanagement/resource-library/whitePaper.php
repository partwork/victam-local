    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-top-elements">
                ...
                <a href="<?php echo base_url('admin/content-management/resource-library/addWhitePaper') ?>" class="btn btn-blue float-right f-14 pl-4 pr-4">Add New White Paper</a>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-12">
            <div class="filter-wrap">
                <div class="status-wrap">
                    ...
                    <select id="wht_statusFilter" class="form-control" required>
                ...
                <div class="search-wrap">
                    <input type="text" class="form-control" id="wht_input_search" placeholder="Search">
                </div>
            </div>
        </div>
        <div class="col-sm-12">
            <div class="table-wrapper">
                <table id="whitePaper" class="display table" style="width:100%;table-layout:fixed;">
