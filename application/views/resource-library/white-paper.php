    ...
    <div class="container-fluid pr-0 pl-0">
        ...
        <div class="row pr-5">
                ...
                <div class="filters-wrap">
                    ...
                    <div class="input-fields-wrap mt-2" id="filter_div">
                        <div class="form-group search-filter-wrap pos-rel">
                            <input type="text" class="form-control" id="filterSearch" placeholder="Search for a whitepapers">
                            <i class="fa fa-search" id="Searchme" aria-hidden="true"></i>
                            <input type="hidden" name="page_name" id="page_name" value="whitepapers">
                        ...
                        <div class="form-group search-filter-wrap pos-rel">
                            <a href="<?php echo base_url(); ?>index.php/resource-library/add-white-paper" class="btn btn-blue w-100 f-14 fw-400">Add Your Whitepaper</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-9 mt-4 pb-5" id="comp-directory">
                ...
                <h4 class="text-title-small fw-400 mb-5">LIST OF WHITEPAPER</h4>

                <div class="row mt-3 scroll-section pt-1" id="Ajaxresult">
                    
                       <?php
                       $not_in='';
                          if(isset($whitepapers_list)):
                            $i=0;
                            
                            foreach($whitepapers_list as $key=>$value):
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h4 class="text-center text-title-small fw-400 modal-title-innovation">Whitepaper <br/>Contact Form</h4>
                        ...
                        <form id="inov_contact_frm">
                            ...
                            <input type="hidden" name="resource" id="research_and_innovations" value="whitepapers">
                            <div class="innovation-contact-form-wrap">
                                ...
                                <input type="hidden" name="reqpage" value="White Paper">
          ...
          <div class="modal-dialog modal-xl" style="margin: 0 auto;height: 100%;">
            <div class="modal-content" style="background:transparent;border:none;height: 100%;">
              <div class="modal-body" style="padding: 0;">
                <iframe id="doc_iframe" width="100%" height="100%" style="border: none;"  src="http://www.africau.edu/images/default/sample.pdf"></iframe>
              </div>
            </div>
          </div>
        </div>
