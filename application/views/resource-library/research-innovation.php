    ...
    <div class="container-fluid pr-0 pl-0">
        ...
        <div class="row pr-5">
                ...
                <div class="filters-wrap">
                    ...
                    <div class="input-fields-wrap mt-2" id="filter_div">
                        <div class="form-group search-filter-wrap pos-rel">
                            <input type="text" class="form-control" id="filterSearch" placeholder="Search for a research & innovation">
                            <i class="fa fa-search" id="Searchme" aria-hidden="true"></i>
                            <input type="hidden" name="page_name" id="page_name" value="innovation">
                        ...
                        <div class="form-group search-filter-wrap pos-rel">
                            <a href="<?php echo base_url(); ?>index.php/resource-library/add-innovation" class="btn btn-blue w-100 f-14 fw-400">Add Your Innovation</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-9 mt-4 pb-5" id="comp-directory">
                ...
                <h4 class="text-title-small fw-400 mb-5">LIST OF RESEARCH & INNOVATION</h4>

                <div class="row mt-3 scroll-section pt-1" id="Ajaxresult">
                    
                       <?php
                       $not_in='';
                          if(isset($innovation_list)):
                            $i=0;
                            
                            foreach($innovation_list as $key=>$value):
            ...
            <div class="col-sm-9 mt-4 pb-5 comp-detail-directory" id="comp-detail-directory<?php echo $value->idvic_resource_library;?>" style="display:none;">
                <div class="row">
                    ...
                    <div class="col-sm-2 mt-3">
                        <!-- <a target="_blank" href="<?php echo base_url($value->vic_resource_docs);?>"> -->
                        <a href="javascript:void(0)" class="view_doc_model p_file" data-url="<?php echo base_url('upload/resource_library/'.$value->vic_resource_docs);?>" >
                            <img src="https://banner2.cleanpng.com/20180428/gie/kisspng-computer-icons-data-file-document-file-format-5ae44cd0f26028.4611855915249113129928.jpg" class="img-fluid"> 
                        </a>
                    </div>
                   <?php endif; ?> 
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h4 class="text-center text-title-small fw-400 modal-title-innovation">Research And Innovations <br/>Contact Form</h4>
                        ...
                        <form id="inov_contact_frm">
                            ...
                            <input type="hidden" name="resource" id="research_and_innovations" value="research_and_innovations">
                            <div class="innovation-contact-form-wrap">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control form-control-custom" name="mobile" placeholder="Enter Phone Number" required="" onkeypress="return onlyNumberKey(event)">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <input type="hidden" name="reqpage" value="Research Innovation">
