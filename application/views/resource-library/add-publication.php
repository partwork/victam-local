...
<body>
    ...
    <input type="hidden" id="reqpage" class="reqpagevalue" value="Add your publications form">
            ...
            <div class="row">
                <div class="col-12 col-sm-12 col-lg-9 col-md-9">
                    <div class="col-sm-12 p-0">
                        <div class="pl-5 pr-5">
                            <h4 class="pt-4 text-title-small">ADD YOUR PUBLICATION</h4>
                            ...
                            <p class="text-title-small mt-5 mb-2 fw-500">
                                Please complete the below form accurately to enlist your publications with us
                            </p>
                        </div>
                    </div>
                    <div class="pl-5">
                        <div class="write-for-us-form">
                            <form action="<?php echo base_url('store_resource') ?>" method="post" id="add_resource_frm" enctype="multipart/form-data">
                                ...
                                <div class="row p-2">
                                    ...
                                    <div class="col-sm-3 "><label class="m-0" for="usr">Publication Title <span class="text-danger">*</span> </label></div>
                                    <div class="col-sm-9 "><input type="text" name="title" id="title" class="form-control form-control-custom" placeholder="Enter Publication Title "></div>
                                </div>
                                <div class="row p-2">
