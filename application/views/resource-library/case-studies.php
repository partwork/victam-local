...
<body>
    ...
    <div class="container-fluid pr-0 pl-0">
        ...
        <div class="row pr-5" id="source_detail_section">
            <div class="col-sm-3">
                <div class="filters-wrap">
                    ...
                    <div class="input-fields-wrap mt-2" id="filter_div">
                        <div class="form-group search-filter-wrap pos-rel">
                            <input type="text" class="form-control" id="filterSearch" placeholder="Search for case studies">
                            <input type="hidden" name="page_name" id="page_name" value="case_study">
                        ...
                        <div class="form-group">
                            ...
                            <div class="dropdowns">
                                ...
                                <select class="form-control function-drp-list sector-drp-list" id="sector-drp-list" required>
                        ...
                        <div class="form-group search-filter-wrap pos-rel">
                            <a href="<?php echo base_url(); ?>index.php/resource-library/add-casestudy" class="btn btn-blue w-100 f-14 fw-400">Add Your Case Study</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-9 mt-4 pb-5" id="case-directory">

                <h4 class="text-title-small fw-400 mb-5">LIST OF CASE STUDY</h4>

                <div class="row mt-3 scroll-section pt-1" id="Ajaxresult">
                    <?php
                    $not_in = '';
                    if (isset($casestudy_list)) :
                        $i = 0;

                        foreach ($casestudy_list as $key => $value) :
                            $not_in .= $value->idvic_resource_library . ',';
                    ?>
                            <div class="col-sm-12">
                                <button type="button" class="comp-card-wrap p-3 bg-white text-dark view-case-detail" data-id="<?php echo $value->idvic_resource_library; ?>">
                                    ...
                                    <!-- <img src="<?php echo base_url(); ?>application/assets/shared/img/research_innovation/research-innovation_1.png" /> -->
                                    <!-- <button type="button" class="btn btn-sm btn-blue view-comp-detail" data-id="<?php echo $value->idvic_resource_library; ?>">View</button> -->
                                </button>
                                <!-- <div class="comp-card-wrap">
                            <img src="<?php echo base_url(); ?>application/assets/shared/img/research_innovation/casestudy1.png" />
                            <button type="button" data-id="<?php echo $value->idvic_resource_library; ?>" class="btn btn-sm btn-blue view-case-detail">View</button>
                        </div> -->
                            </div>
                    <?php
                        endforeach;
            ...
            if (isset($casestudy_list)) :
                ...
                foreach ($casestudy_list as $key => $value) :
            ?>
                    <div class="col-sm-9 mt-4 pb-5 case-detail-directory" id="case-detail-directory<?php echo $value->idvic_resource_library; ?>" style="display:none;">
                        <div class="row">
                            <div class="col-sm-12">
                                <button type="button" class="btn btn-sm btn-blue back-to-case-directory float-right mb-3 pl-4 pr-4">Back</button>
                                ...
                                <li class="list-inline-item">
                                    <a href="https://www.facebook.com/dialog/share?app_id=<?php echo $this->config->item('facebook_app_id'); ?>&href=http://dev.victam.com/e/CommonController/get_resource_library_details_by_id/<?php echo $value->idvic_resource_library ?>" target="_blank">
                                        ...
                                        <li class="list-inline-item"> <a href="https://twitter.com/intent/tweet?text=<?php echo $value->vic_resource_title .' - '.$value->vic_resource_desc; ?>" target="_blank"> <i class="fa fa-twitter fa-icon-social"></i> </a> </li>
                                    </ul>
                                </div>
                            </div>
                           ...
                           <?php endif; ?>
                            <div class="col-sm-12 mt-5">
                                <!-- <button type="button" class="btn btn-blue pl-5 pr-5 more_info" data-resid="<?php echo $value->idvic_resource_library; ?>" data-toggle="modal" data-target="#receiveMoreInfo">Receive More Information</button> -->
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h4 class="text-center text-title-small fw-400 modal-title-innovation">Case Study <br />Contact Form</h4>
                    ...
                    <form id="inov_contact_frm">
                        ...
                        <input type="hidden" name="resource" id="research_and_innovations" value="case_studies">
                        <div class="innovation-contact-form-wrap">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control form-control-custom" name="name" placeholder="Enter Contact Name">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="" class="col-sm-4 col-form-label">Email ID <span class="text-red">*</span></label>
                                <div class="col-sm-8">
                                    <input type="email" class="form-control form-control-custom" name="email" placeholder="Enter Email ID">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control form-control-custom" name="mobile" onkeypress="return onlyNumberKey(event)" placeholder="Enter Phone Number">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="" class="col-sm-4 col-form-label">Company Name <span class="text-red">*</span></label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control form-control-custom" name="company" placeholder="Enter Company Name">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="" class="col-sm-4 col-form-label">Designation / Title <span class="text-red">*</span></label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control form-control-custom" name="designation" placeholder="Enter Designation / Title">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="" class="col-sm-4 col-form-label">Country <span class="text-red">*</span></label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control form-control-custom" name="country" placeholder="Enter Country">
                                </div>
                            </div>
                            <input type="hidden" name="reqpage" value="Case Studies">
