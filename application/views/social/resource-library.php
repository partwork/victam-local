...
<html lang="en">
<head>
    <meta property="og:url"  content="<?php echo base_url('e/CommonController/get_resource_library_details_by_id/'. $company['0']->id) ?>" />
...
<script>
window.location.replace("http://dev.victam.com/resource-library/");
</script>
</head>
<body>
<div class="container">
