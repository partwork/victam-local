...
<html lang="en">
<head>
    <meta property="og:url"  content="<?php echo base_url('e/CommonController/get_company_by_id/'. $company['0']->id) ?>" />
...
<script>
window.location.replace("http://dev.victam.com/e/WhoIsWhoController/load_Company_Directory_View/");
</script>
</head>
<body>
<div class="container">
