                ...
                <div class="all-form-wrap">
                    ...
                    <div class="form-1 form-wrap active">
                        <div class="form-group">
                            <h4 for="exampleInputEmail1" class="pb-3 text-center mb-4">FIND BUYERS</h4>
                            <div class="row pt-1">
                                <div class="text-left col-sm-12">
                                    <h5 class="wizard-title"> 1. For what industries you are supplying?<span class="text-danger">*</span> </h5>
                                </div>
                    ...
                    <div class="form-2 form-wrap">
                        <div class="form-group">
                            ...
                            <div class="row pt-1">
                                <div class="text-left col-sm-12">
                                    <h5 class="wizard-title"> 2. Target groups<span class="text-danger">*</span> </h5>
                                </div>
                                <div class="col-12 col-sm-12 col-md-6 col-lg-6 p-1">
                    ...
                    <div class="form-3 form-wrap">
                        <div class="form-group">
                            ...
                            <div class="row pt-1">
                                <div class="text-left col-sm-12">
                                    <h5 class="wizard-title"> 3. Target Capacity Clients<span class="text-danger">*</span> </h5>
                                </div>
                                <div class="col-12 col-sm-12 col-md-6 col-lg-6 p-1">
                    ...
                    <div class="form-4 form-wrap">
                        <div class="form-group">
                            ...
                            <div class="row pt-1">
                                <div class="text-left col-sm-12">
                                    <h5 class="wizard-title">4. What is your trade position<span class="text-danger">*</span> </h5>
                                </div>
                                <div class="col-12 col-sm-12 col-md-6 col-lg-6 p-1">
                    ...
                    <div class="form-5 form-wrap">
                        <div class="form-group">
                            ...
                            <div class="row pt-1">
                                <div class="text-left col-sm-12">
                                    <h5 class="wizard-title">5. What products or services are you offering<span class="text-danger">*</span> </h5>
                                </div>
                                <div class="col-12 col-sm-12 col-md-6 col-lg-6 p-1">
                    ...
                    <div class="form-6 form-wrap">
                        <div class="form-group">
                            ...
                            <div class="row pt-1">
                                <div class="text-left col-sm-12">
                                    <h5 class="wizard-title">6. Our most important USP’s  <span class="f-14 text-small-grey">(Multi-selection fields)</span><span class="text-danger">*</span> </h5>
                                </div>
                                <div class="col-12 col-sm-12 col-md-6 col-lg-6 p-1">
                    ...
                    <div class="form-7 form-wrap">
                        <div class="form-group">
                            ...
                            <div class="row pt-1">
                                <div class="text-left col-sm-12">
                                    <h5 class="wizard-title">7. Where we deliver our product or service<span class="text-danger">*</span> </h5>
                                </div>
                                <div class="col-12 col-sm-12 col-md-6 col-lg-6 p-1">
                       ...
                       <div class="form-8 form-wrap">
                        <div class="form-group">
                            ...
                            <div class="row pt-1">
                                <div class="text-left col-sm-12">
                                    <h5 class="wizard-title">8. Ready for orders within<span class="text-danger">*</span> </h5>
                                </div>
                                <div class="col-12 col-sm-12 col-md-6 col-lg-6 p-1">
                        ...
                        <div class="form-group">
                            ...
                            <div class="row pt-1">
                                ...
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12 p-1">
                                    <textarea class="form-control" rows="5" id="additionalInfo" name="additionalInfo" ></textarea>
                                </div>
                            ...
                            <div class="text-center pt-3 mt-4">
                                <input type="hidden" id="" name="" value="0">
                                <button type="button" class="btn back-btn pl-5 pr-5 mr-3">Back</button>
                                <button type="button" id="finishquestionsbuyers" class="btn btn-blue pl-5 pr-5">Finish</button>
                            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body p-5">
                    ...
                    <img class="mb-4" src="<?php echo base_url(); ?>application/assets/shared/img/admin/logo.png">
                        <div id="buyersText"></div>
                        <div class="text-center mt-4">
                            <a class="td-none" href="<?php echo base_url(); ?>matchmaking/buyers_list">
