        ...
        <div id="demo" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="carousel-img" src="<?php echo base_url(); ?>application/assets/shared/img/banners/events-on-off.png" height="200">
                    <div class="carousel-caption" style="bottom: 20px;">
                        <div class="carousel-caption">
                            <h1 class="carousel-title">ONLINE EVENTS</h1>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="pl-3 pt-3 mt-3">
            ...
            <div id="accordion">
                ...
                <div class="card mt-2 mb-2 ml-3 mr-4 event-card">
                        ...
                        <div id="januaryOne">
                            <div class="event-calender-info" data-toggle="collapse" data-target="#collapse<?= $k ?>" aria-expanded="<?php if ($k == 0) echo 'false' ?>" aria-controls="collapseOne">
                        ...
                        <?php foreach ($upcoming_events as $event) : ?>
                            <div class="event-item-wrap">
                                <img class="interview-img"  src="<?php echo base_url() .'upload/event/' . $event->vic_logo; ?>" style="width: 100%;">
                                    ...
                                    <a onclick="update_registration_count('<?= $event->vic_registration_url ?>', '<?= $event->idvic_events ?>')" href="javascript:void(0);" class="btn btn-blue form-control btn-sm">Register</a>
                            </div>
                        <?php endforeach; ?>
                    </div>
                </section>
